...
invite_url = "https://www.genspark.ai/invite?invite_code=MTMzMGJiNDdMNmI2MEwwMjk0TGQ4YThMYjkwOTQ2YjFmMTgy"
...
def register(invite_url):
    with sync_playwright() as p:
        ...
        print("[+]注册成功，开始填写手机号")
        time.sleep(10)
        country_code = page.locator(
            'xpath=//*[@id="__nuxt"]/div/div/div/div[3]/div[2]/div[2]/div[1]/div/div[1]/div/div/span/span[2]').text_content().replace(
            " ", "")
